...
- Frequency: **434.0 MHz**
- Bit rate: **4.8 kbps** (a 9.6 kbps trial on 2026-07-03 was reverted the same day —
  heavy packet loss left most tiles blank; only retry with a `--record` capture to
  analyze). Bit rate + deviation live in `protocol.h` as `PHY_*` constants — change
